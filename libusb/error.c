 ...
 * - commented-out the contents of this file since none of it
 *   is used by libusb itself (it is used by the C++ files & by
 *   some of the tests - if you build them, remove the '#if 0')
 *
 */
